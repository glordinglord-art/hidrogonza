...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    client: "Constructora Capital",
    location: "Zipaquirá, Cundinamarca",
    image: "https://images.unsplash.com/photo-1541888086925-ebc660bc49f4?q=80&w=1600&auto=format&fit=crop",
    category: "desagues",
    tagline: "Sistemas de evacuación y ventilación",
    summary: "Redes de desagüe y ventilaciones para conjunto residencial.",
    description:
      "Montaje de sistemas de desagüe para aguas negras y pluviales, con ventilaciones y reventilaciones, en el conjunto residencial Carrara.",
    scope: ["Aguas negras y pluviales", "Ventilaciones", "Reventilaciones"],
  },
];
