export const IMAGES = {
  /** Ícono HG fondo transparente (header, etc.) */
  logoIcon: "/logo-transparent.png",
  /** Logo completo alta resolución — fondo negro, usar con mix-blend-screen en hero */
  logoHero: "/logo-hero.png",
  /** Logo completo (respaldo) */
